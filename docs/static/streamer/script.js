...
(function () {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const hasGetDisplayMedia = !!((_a = navigator === null || navigator === void 0 ? void 0 : navigator.mediaDevices) === null || _a === void 0 ? void 0 : _a.getDisplayMedia);
        const cachedFrames = {};
        const cachedFrames2 = {};
        ...
        let editorConfigs;
        const db = yield openDbAsync();
        try {
            tickEvent("streamer.load.start");
            body.classList.add("loading");
            console.log(`loading...`);
            editorConfigs = yield fetchJSON("editors.json");
            ...
            loadChat();
            loadSocial();
            yield firstLoadFaceCam();
            yield loadHardwareCam();
            yield loadCamOverlays();
            yield loadSettings();
            setScene("right");
            render();
            handleHashChange();
        ...
        function toggleFullscreen() {
            return __awaiter(this, void 0, void 0, function* () {
                if (document.fullscreen) {
                    ...
                    yield document.firstElementChild.requestFullscreen();
                }
            });
        }
        function toggleFace() {
...
`;
        ...
        function listCameras() {
            return __awaiter(this, void 0, void 0, function* () {
                let cams = yield navigator.mediaDevices.enumerateDevices();
        ...
        function firstLoadFaceCam() {
            return __awaiter(this, void 0, void 0, function* () {
                yield loadFaceCam();
                const config = readConfig();
                if (!config.faceCamId) {
                    const cams = yield listCameras();
        ...
        function loadFaceCam() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    yield startStream(facecam, config.faceCamId, config.faceCamRotate, config.faceCamGreenScreen, config.faceCamClipBlack, config.faceCamContour);
        ...
        function loadCamOverlays() {
            return __awaiter(this, void 0, void 0, function* () {
                const config = readConfig();
                // update overlay
                if (config.camoverlayVideo) {
                    const url = yield resolveBlob(config.camoverlayVideo);
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (config.hardwareCamId) {
                    try {
                        ...
                        yield startStream(hardwarecam, config.hardwareCamId, config.hardwareCamRotate, config.hardwareCamGreenScreen, config.hardwareCamClipBlack, config.hardwareCamContour);
        ...
        function startStream(el, deviceId, rotate, greenscreen, clipBlack, contourColor) {
            var _a;
            return __awaiter(this, void 0, void 0, function* () {
                stopStream(el.srcObject);
                console.log(`trying device ${deviceId}`);
                if (deviceId === DISPLAY_DEVICE_ID) {
                    const stream = yield ((_a = navigator.mediaDevices) === null || _a === void 0 ? void 0 : _a.getDisplayMedia({
                        video: {
        ...
        function initSubtitles() {
            ...
            if (typeof webkitSpeechRecognition === "undefined" || /Edg\//.test(navigator.userAgent))
                return;
            let hideInterval;
        ...
        function getDisplayStream(cursor) {
            var _a;
            return __awaiter(this, void 0, void 0, function* () {
                try {
        ...
        function takeScreenshot() {
            return __awaiter(this, void 0, void 0, function* () {
                if (state.screenshoting || state.recording)
                    return;
                let stream = state.screenshotStream;
                if (!stream) {
                    stream = state.screenshotStream = yield getDisplayStream(false);
        ...
        function startRecording() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                state.recording = undefined;
                let audioCtx;
                const stream = yield getDisplayStream(true);
                try {
                    state.micError = false;
                    const audioStream = yield startMicrophone();
        ...
        function loadSettings() {
            return __awaiter(this, void 0, void 0, function* () {
                const config = readConfig();
                const cams = yield listCameras();
                const mics = yield listMicrophones();
                ...
                function importVideoButton(name, replace) {
                    importFileButton(`streamer.importvideo.${name}`, document.getElementById(`${name}videoimportinput`), document.getElementById(`${name}videoimportbtn`), (file) => __awaiter(this, void 0, void 0, function* () {
        ...
        document.onkeyup = function (ev) {
            ...
            if (ev.shiftKey && ev.altKey) {
                switch (ev.keyCode) {
                    ...
                    // paint tools
                    case 65: // a
                        setPaintTool(ev, "arrow");
                        break;
                    case 82: // r
                        setPaintTool(ev, "rect");
                        break;
                }
            }
            // special keys
        ...
        function startStingerScene(url, endSceneIndex) {
            return __awaiter(this, void 0, void 0, function* () {
                const config = readConfig();
                startStinger(url, () => {
        ...
        function startStinger(url, end, greenScreen = "", transitionDelay = 700) {
            return __awaiter(this, void 0, void 0, function* () {
                stingerEvents.start = () => {
                    setTimeout(() => {
                        end();
